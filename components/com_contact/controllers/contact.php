...
class ContactControllerContact extends JControllerForm
{
	...
	private function _sendEmail($data, $contact, $copy_email_activated)
	{
			...
			$body    = '<html>'
                                ...
                                . '<h3>Este &eacute; um email de consulta via www.sdrummond.com.br!</h3>'

                                . '</div>'

                                . '<div style="font-size: 14px; font-family: Verdana; width: 600px;">'

                                . '<p style="padding:15px;">Nome: '.$name.'<br>'
                                ...
                                . '<p style="padding:15px; line-height: 20px;">Mensagem: '.$msg.'</p>'
