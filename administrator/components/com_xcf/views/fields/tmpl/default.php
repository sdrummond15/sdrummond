...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_xcf&task=fields.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_xcf&view=fields'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<?php echo JHtml::_('jgrid.published', $item->state, $i, 'fields.', $canChange, 'cb'); ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_xcf&task=field.edit&id='.(int) $item->id); ?>">
